...
const SuccessMessage: React.FC = () => {
    ...
    return (
        <div
            className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-[9999] transition-all duration-300 ease-in-out ${success ? 'translate-y-0 opacity-100' : '-translate-y-16 opacity-0'
                }`}
        >
