    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="mb-2">
                ...
                <div className="bg-white/5 rounded-lg px-2 border border-white/5 h-[45px] overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 flex items-center py-1.5">
                    {tags && tags.length > 0 ? (
