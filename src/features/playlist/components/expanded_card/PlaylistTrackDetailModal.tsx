...
export const PlaylistTrackDetailModal: React.FC<PlaylistTrackDetailModalProps> = ({ track, onClose }) => {
    ...
    const { isLiked, toggleLike } = useFavourites(track.id, 'track');
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex gap-4 w-full justify-center">
                            ...
                            <a
                                ...
                                className="flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[#1DB954] hover:bg-[#1ed760] text-black font-bold transition-all hover:scale-105 shadow-lg flex-1 max-w-[200px]"
                            >
                            ...
                            <button
                                onClick={toggleLike}
                                className={`flex items-center justify-center gap-2 px-6 py-3 rounded-full font-bold transition-all hover:scale-105 shadow-lg flex-1 max-w-[200px] border ${isLiked
                                    ? 'bg-[#FFD1D1]  text-black border-[#FFD1D1]'
