                    ...
                    <div className="flex-1 flex flex-col min-w-0">
                        ...
                        {loading ? (
                            ...
                            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
                                ...
                                {topThree.length > 0 && (
                                    <div className="mb-8">
                                        <h2 className="text-lg font-bold text-[#D1D1D1] mb-4">Top Trending</h2>
                                        <div className="grid grid-cols-3 gap-4">
                                            {topThree.map((item, index) => (
                                                <HeroCard key={item.id} item={item} rank={index + 1} />
                                            ))}
                                        </div>
                                    </div>
                                )}
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-2">
                                            {remaining.map((item, index) => (
                                                <TrendingRow key={item.id} item={item} rank={index + 4} />
                                            ))}
                                        </div>
                                    </div>
                                )}
